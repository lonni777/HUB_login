...
2. **Створити `.env`** у **корені** репозиторію (на основі `.env.example`) та заповнити обов'язкові змінні (логін, пароль, URL тощо). Його використовують і tests-ts, і tests-Python.
...
## Документація (Python, legacy)

Чеклист перед запуском, історія міграції на TS, аналіз продуктивності: [docs/](docs/).

---

Цей набір тестів більше не розширюється новими кейсами. Усі нові тести пишуться в **tests-ts/** (TypeScript). Актуальна документація проєкту — у [../docs/](../docs/).
